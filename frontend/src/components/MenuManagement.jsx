...
const MenuManagement = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.post("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/menu", formData, {
        headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/menu/${editingMenu}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.delete(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/menu/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleRestockSubmit = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/menu/${restockMenu._id}`,
        {
  ...
  const handleBulkRestock = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/menu/restock-all",
