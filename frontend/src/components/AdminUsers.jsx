...
const AdminUsers = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/users", {
  ...
  const handleRoleChange = async (id, newRole) => {
    ...
    try {
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/user/${id}/role`,
        { role: newRole },
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleDeactivate = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/user/${id}/deactivate`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleReactivate = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.put(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/user/reactivate/${id}`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
