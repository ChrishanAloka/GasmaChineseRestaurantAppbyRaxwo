    ...
    const fetchMyRequests = async () => {
      try {
        ...
        const res = await axios.get(
          "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/kitchen/my-requests",
          {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/kitchen/request",
        formData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
