...
const ExpensePage = () => {
  ...
  const handleCreateMenuSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/menu", payload, {
  ...
  const fetchSuppliers = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/suppliers", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchExpenses = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/expenses", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const url = editingId
        ? `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/expense/${editingId}`
        : "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/expense/add";
  ...
  const handleDelete = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.delete(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/expense/${deleteId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
