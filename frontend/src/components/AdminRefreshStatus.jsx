    ...
    const fetchStatus = async () => {
      try {
        ...
        const res = await axios.get(
          "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/refresh-status",
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/refresh-status/reset",
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
