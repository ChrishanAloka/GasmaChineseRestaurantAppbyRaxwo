...
const CashierSummary = () => {
  ...
  const fetchCashOrders = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/orders?${params.toString()}&limit=500`,
  ...
  const fetchOtherIncomes = async () => {
    try {
      const res = await axios.get(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/income/other/by-date?date=${dateFilter}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchOtherExpenses = async () => {
    try {
      const res = await axios.get(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/expense/other/by-date?date=${dateFilter}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const fetchForwardBalance = async (currentDate) => {
    try {
      ...
      const res = await axios.get(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/cashier/shift-summary/${yesterdayStr}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const checkExistingSummary = async () => {
    try {
      const res = await axios.get(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/cashier/shift-summary/${dateFilter}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const addOtherIncome = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/income/other",
        payload,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const addOtherExpense = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/expense/other",
        payload,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const deleteOtherIncome = async (id) => {
    ...
    try {
      await axios.delete(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/income/other/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const deleteOtherExpense = async (id) => {
    ...
    try {
      await axios.delete(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/expense/other/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/cashier/shift-summary/submitshift",
        payload,
        { headers: { Authorization: `Bearer ${token}` } }
      );
