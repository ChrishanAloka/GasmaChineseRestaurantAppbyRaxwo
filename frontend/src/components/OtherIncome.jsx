...
const OtherIncome = () => {
  ...
  const fetchIncomes = async () => {
    ...
    try {
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/income/other", {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/income/other/${editingIncome}`,
        editData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
