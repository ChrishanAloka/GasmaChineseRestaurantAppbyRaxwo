...
const KitchenBills = () => {
  ...
  const fetchBills = async () => {
    ...
    try {
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/kitchen/bills", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/kitchen/bill",
        newBill,
        {
          headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/kitchen/bill/${editingBill}`,
        editData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.delete(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/kitchen/bill/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
