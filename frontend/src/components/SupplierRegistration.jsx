...
const SupplierRegistration = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/supplier/register",
        newSupplier,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/supplier/${editingSupplier}`,
        editData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/supplier/${id}`, {
