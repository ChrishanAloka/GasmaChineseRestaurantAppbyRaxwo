  ...
  useEffect(() => {
    const fetchEmployee = async () => {
      try {
        ...
        const res = await axios.get(`https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/employee/${id}`, {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/employee/${id}`,
        formData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
