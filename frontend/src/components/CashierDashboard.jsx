  ...
  const fetchData = async (dateStr) => {
    ...
    try {
      const [summaryRes, ordersRes] = await Promise.all([
        axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/admin/summary", {
          headers: { Authorization: `Bearer ${token}` },
          params: { startDate, endDate }
        }),
        axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/orders?limit=1000", {
          headers: { Authorization: `Bearer ${token}` },
          params: { startDate, endDate }
        })
      ]);
