...
const SalaryPage = () => {
  ...
  const fetchSalaries = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/salaries", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/salary/add",
        payload,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
