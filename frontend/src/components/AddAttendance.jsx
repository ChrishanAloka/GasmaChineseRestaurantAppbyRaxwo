  ...
  const fetchPunches = async (empId) => {
    ...
    try {
      ...
      const res = await axios.get(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/attendance/summary",
        {
  ...
  const recordPunch = async (type) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/attendance/punch",
        payload,
        {
          headers: {
