...
const CashierLanding = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      try {
        ...
        const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/customer", {
  ...
  const fetchWaiters = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/employees", {
        headers: { Authorization: `Bearer ${token}` }
      });
    ...
    if (digits.length >= 2) {
      ...
      try {
        ...
        const res = await axios.get(
          "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/customers-search",
          {
            params: { q: digits },
            headers: { Authorization: `Bearer ${token}` }
          }
  ...
  const fetchMenus = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/menus", {
        headers: { Authorization: `Bearer ${token}` }
      });
      setMenus(res.data);
  ...
  const fetchOrdersAndComputePopularity = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/orders?limit=500", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchServiceCharge = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/admin/service-charge",
        {
          headers: { Authorization: `Bearer ${token}` }
        }
      );
  ...
  //   try {
  //     const token = localStorage.getItem("token");
  //     const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/admin/delivery-charge", {
  //       headers: { Authorization: `Bearer ${token}` }
  //     });
  ...
  const fetchDeliveryPlaces = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.get("https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/delivery-charges", { // ✅ updated endpoint
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const submitConfirmedOrder = async (paymentData) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/order",
        payload,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
                    ...
                    onChange={async (selectedOption) => {
                      if (selectedOption && selectedOption.value === "__CREATE_NEW__") {
                        ...
                        try {
                          const token = localStorage.getItem("token");
                          const res = await axios.post(
                            "https://gasmachineserestaurantappbyraxwo.onrender.com/api/auth/delivery-charges",
                ...
                <div key={menu._id} className="col-12 col-md-4 col-lg-4 col-xl-3">
                  <div className="card shadow-sm h-100 border-0">
                    ...
                    menu.imageUrl.startsWith("https")
                      ? menu.imageUrl
                      : `https://gasmachineserestaurantappbyraxwo.onrender.com${menu.imageUrl}`
                    }
                    alt={menu.name}
